...
Run:
    python -m qwen3_6.test.test_logits_parity
or:
    QWEN35_MODEL_PATH=/path/to/Qwen3.5-4B python -m qwen3_6.test.test_logits_parity
"""
...
def main(model_path: str = "") -> int:
    model_path = model_path or os.environ.get(
        "QWEN35_MODEL_PATH", "/root/models/Qwen3.6-27B"
    )
    ...
    with open(os.path.join(model_path, "config.json")) as f:
        hf_cfg = json.load(f)
    from qwen3_6 import Qwen3_6ForConditionalGeneration
