...
"""Factory for Qwen3.6-27B hybrid model selection based on platform/config.
...
class Qwen3_6ForConditionalGeneration(nn.Module):
    """Factory that validates config and selects the Qwen3.6 implementation."""
    ...
    def _validate_config(
        ...
        if quantization == "mxfp4":
            raise ValueError(
                "quantization='mxfp4' is not yet supported for Qwen3.6. "
