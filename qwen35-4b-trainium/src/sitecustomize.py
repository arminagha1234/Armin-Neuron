...
PYTHONPATH (or in site-packages). We use it to ensure the Qwen3.5
...
logger = logging.getLogger("qwen3_5.sitecustomize")

if os.environ.get("QWEN35_DISABLE_AUTO_REGISTER") != "1":
    try:
        # Triggers __init__.py which runs register() at import-time.
        import qwen3_5  # noqa: F401
        logger.info("qwen3_5 sitecustomize: auto-import + register OK")
    except Exception as exc:
        logger.warning(
            "qwen3_5 sitecustomize: auto-register failed: %r", exc
        )
