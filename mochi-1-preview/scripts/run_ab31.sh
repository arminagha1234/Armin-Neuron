...
cd /host/Mochi
torchrun --nnodes 1 --nproc_per_node 4 --rdzv_backend c10d --rdzv_endpoint localhost:29500   nki_kernels/ab_bench.py --frames 31 --steps 5 --warmup 2 --guidance-scale 4.5 "$@"
