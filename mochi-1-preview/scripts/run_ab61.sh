...
cd /host/Mochi
torchrun --nnodes 1 --nproc_per_node 4 --rdzv_backend c10d --rdzv_endpoint localhost:29500   nki_kernels/ab_bench.py --frames 61 --steps 4 --warmup 1 --guidance-scale 1.0 "$@"
