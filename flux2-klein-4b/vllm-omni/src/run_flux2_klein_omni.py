...
Mirrors the LTX-2 omni runner pattern. Loads the model under our
`NeuronFlux2KleinPipeline` (registered for `model_arch="Flux2KleinPipeline"`),
optionally fuses an external zoom-LoRA, and runs a few canonical
inference calls.
...
parser.add_argument("--lora-path", type=str,
                    ...
                    help=(
                        ...
                        "Example: <provider>/flux-2-klein-4B-zoom-lora "
                        "(file: flux-red-zoom-lora.safetensors)."
                    ))
parser.add_argument("--lora-scale", type=float, default=1.1,
                    help="LoRA scale; the reference zoom LoRA card recommends 1.1.")
